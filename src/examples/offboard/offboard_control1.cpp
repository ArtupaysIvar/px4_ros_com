...
private:
    ...
    Eigen::Vector2f body_pos_setpoint;
    // Eigen::Vector3f body_vel_setpoint;
};
...
void Drone1Control::relative_setpoint(){
    ...
    if (setpoint_counter_ < 10) {
        ...
        traj.position = {
            global_position_2d[0],
            global_position_2d[1],
            current_z
        };
    ...
    target_pos = global_position_2d + (yaw_rotational_matrix * body_pos_setpoint);
